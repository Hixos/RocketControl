...
model Parachute2
  ...
  RocketControl.Components.Parts.ParachuteLine2 parachuteLine(c = c, d = d, s_unstretched = line_length)  annotation(
...
equation
  ...
  connect(chute_body.frame_a, fixedTranslation4.frame_a) annotation(
    Line(points = {{20, 20}, {20, 0}, {52, 0}, {52, -30}, {40, -30}}, color = {95, 95, 95}));
  connect(chute_body.frame_a, fixedTranslation5.frame_a) annotation(
    Line(points = {{20, 20}, {20, 0}, {52, 0}, {52, -60}, {40, -60}}, color = {95, 95, 95}));
  connect(chute_body.frame_a, fixedTranslation3.frame_a) annotation(
  ...
  connect(parachuteAerodynamics.frame_b, chute_body.frame_a) annotation(
