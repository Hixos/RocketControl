...
block TrueFinPositionSensor
 extends Modelica.Icons.RoundSensor;
  Modelica.Blocks.Interfaces.RealOutput control_meas[4](each displayUnit = "deg", each final quantity = "Angle", each final unit = "deg") annotation(
    Placement(visible = true, transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput fin_pos_true[4](each displayUnit = "deg", each final quantity = "Angle", each final unit = "deg") annotation(
