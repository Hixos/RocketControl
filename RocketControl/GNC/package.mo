...
//      end when;
  ...
  extends RocketControl.Interfaces.PartialConditionalEnablePort;
    ...
    parameter Real saturation = 0;
    parameter SI.Duration ts;
    Modelica.Blocks.Interfaces.RealInput ref[n] annotation(
      Placement(visible = true, transformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-120, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    Modelica.Blocks.Interfaces.RealOutput err_int[n](start = zeros(n)) annotation(
      Placement(visible = true, transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
