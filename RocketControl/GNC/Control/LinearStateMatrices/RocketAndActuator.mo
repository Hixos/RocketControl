...
equation
  ...
  A = [                                                                 -(CA0*S*rho*u)/m,     r - (CA_b*S*rho*v)/m,   - q - (CA_a*S*rho*w)/m,                          0,                         -w,                          v,                           0,                           0,                           0;
         (CY_b*S*rho*v)/(2*m) - r + (CY_r*S*c*r*rho)/(2*m) + (CY_dy*S*dys*rho*u)/m,     (CY_b*S*rho*u)/(2*m),                        p,                          w,                          0, (CY_r*S*c*rho*u)/(2*m) - u,     (CY_dy*S*rho*u^2)/(2*m),                           0,                           0;
         q - (CN_a*S*rho*w)/(2*m) - (CN_q*S*c*q*rho)/(2*m) - (CN_dp*S*dps*rho*u)/m,                       -p,    -(CN_a*S*rho*u)/(2*m),                         -v, u - (CN_q*S*c*rho*u)/(2*m),                          0,                           0,    -(CN_dp*S*rho*u^2)/(2*m),                           0;
                            (CLL_p*S*p*rho*c^2)/(4*Ix) + (CLL_dr*S*drs*rho*u*c)/Ix,                        0,                        0, (CLL_p*S*c^2*rho*u)/(4*Ix),                          0,                          0,                           0,                           0, (CLL_dr*S*c*rho*u^2)/(2*Ix);
 (CLM_q*S*c^2*q*rho)/(4*Is) + (CLM_a*S*c*rho*w)/(2*Is) + (CLM_dp*S*c*dps*rho*u)/Is,                        0, (CLM_a*S*c*rho*u)/(2*Is),              r - (Ix*r)/Is, (CLM_q*S*c^2*rho*u)/(4*Is),              p - (Ix*p)/Is,                           0, (CLM_dp*S*c*rho*u^2)/(2*Is),                           0;
 (CLN_r*S*c^2*r*rho)/(4*Is) + (CLN_b*S*c*rho*v)/(2*Is) + (CLN_dy*S*c*dys*rho*u)/Is, (CLN_b*S*c*rho*u)/(2*Is),                        0,              (Ix*q)/Is - q,              (Ix*p)/Is - p, (CLN_r*S*c^2*rho*u)/(4*Is), (CLN_dy*S*c*rho*u^2)/(2*Is),                           0,                           0;
                                                                                 0,                        0,                        0,                          0,                          0,                          0,                         -wa,                           0,                           0;
                                                                                 0,                        0,                        0,                          0,                          0,                          0,                           0,                         -wa,                           0;
                                                                                 0,                        0,                        0,                          0,                          0,                          0,                           0,                           0,                         -wa];
