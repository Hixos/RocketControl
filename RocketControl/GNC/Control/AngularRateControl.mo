...
block AngularRateControl
  ...
  parameter Real Qvec[:] = {1, 1, 0, 0, 0, 0, 0, 0, 100,100,100} * 0.01;
  ...
  AugmentIntegratorState augmentIntegratorState(kint = 1,m = 3, n = 8, p = 3)  annotation(
  ...
  RocketControl.Blocks.Math.Vectors.VectorConcatenate x_1_6(n1 = 2, n2 = 3) annotation(
  ...
  RocketControl.Blocks.Math.Vectors.VectorConcatenate vectorConcatenate(n1 = 5, n2 = 3) annotation(
    Placement(visible = true, transformation(origin = {-28, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  RocketControl.Blocks.Math.Vectors.VectorConcatenate vectorConcatenate2(n1 = 8, n2 = 3) annotation(
...
equation
  ...
  connect(v_body.x_b[2:3], x_1_6.v1) annotation(
