...
block BodyVelocityControlWithActuator
  ...
  RocketControl.Blocks.Math.Vectors.VectorConstant vectorConstant(k = {0, 0, 0}, n = 3) annotation(
    Placement(visible = true, transformation(origin = {-124, -68}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(vectorConstant.v, x_lq.v2) annotation(
    Line(points = {{-112, -68}, {-62, -68}, {-62, -64}}, color = {0, 0, 127}, thickness = 0.5));
  ...
  connect(servoMotor.servo_pos_nonsat, control2Deflection.u) annotation(
    Line(points = {{-18, 74}, {48, 74}, {48, 0}}, color = {0, 0, 127}, thickness = 0.5));
  connect(control2Deflection.deflection, bus.fin_setpoint) annotation(
    Line(points = {{72, 0}, {100, 0}}, color = {0, 0, 127}, thickness = 0.5));
  annotation(
    Icon(graphics = {Rectangle(fillColor = {255, 242, 254}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}, radius = 12), Polygon(origin = {-72, -22}, fillColor = {91, 91, 91}, fillPattern = FillPattern.Solid, points = {{-2, -12}, {8, -22}, {22, 12}, {12, 22}, {-22, 8}, {-2, -12}}), Polygon(origin = {-41, 9}, fillColor = {155, 183, 193}, fillPattern = FillPattern.Solid, points = {{-43, -33}, {25, 35}, {45, 45}, {35, 25}, {-33, -43}, {-37, -39}, {-43, -33}}), Line(origin = {24.4844, 12.5364}, points = {{-56, -7}, {56, 7}}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 12), Line(origin = {30.3844, 41.6364}, points = {{-15.9035, 23.9035}, {0.0964559, 17.9035}, {8.09646, 7.90354}, {14.0965, -4.09646}, {16.0965, -24.0965}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 21), Text(origin = {-1, -68}, extent = {{-77, 18}, {77, -18}}, textString = "vtrack"), Text(origin = {2, -250}, lineColor = {0, 0, 255}, extent = {{-150, 150}, {150, 110}}, textString = "%name")}, coordinateSystem(grid = {2, 0})));
