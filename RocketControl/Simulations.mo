...
package Simulations
  ...
  package Internal
    ...
    annotation(
        Icon(coordinateSystem(grid = {2, 0}), graphics = {Polygon(fillColor = {29, 163, 125}, fillPattern = FillPattern.Solid, lineThickness = 1.5, points = {{-80, 80}, {-80, -80}, {80, 0}, {-80, 80}})}));end Icon;
    annotation(
      Icon(coordinateSystem(grid = {2, 0})));
  end Internal;
  annotation(
