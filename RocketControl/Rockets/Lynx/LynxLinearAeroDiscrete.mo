...
equation
  ...
  connect(aerodynamics.frame_b, lynxBody.ref_center) annotation(
    Line(points = {{-28, 82}, {-40, 82}, {-40, 0}}, color = {95, 95, 95}));
  connect(bus.fin_setpoint, vectorHold.u) annotation(
    Line(points = {{100, 90}, {100, 20}, {84, 20}}, thickness = 0.5));
  connect(tFServoMotor.servo_pos, aerodynamics.finDeflection) annotation(
    Line(points = {{16, 20}, {-32, 20}, {-32, 75}, {-28, 75}}, color = {0, 0, 127}, thickness = 0.5));
