...
model LynxLinearAeroDiscrete
  ...
  RocketControl.Components.Actuators.TFServoMotor tFServoMotor(a = {0.0769, 1})  annotation(
...
equation
  ...
  connect(linearAerodynamics.frame_b, lynxBody.ref_center) annotation(
    Line(points = {{-20, 80}, {-40, 80}, {-40, 0}}, color = {95, 95, 95}));
  ...
  connect(tFServoMotor.servo_pos, linearAerodynamics.finDeflection) annotation(
    Line(points = {{16, 20}, {-32, 20}, {-32, 73}, {-20, 73}}, color = {0, 0, 127}, thickness = 0.5));
