...
model LinearAerodynamics
  ...
  extends RocketControl.Aerodynamics.PartialAerodynamics(redeclare LinearAerodynamicForce aerodynamicForce(nCAO = nCAO, machCA0 = machCA0, CA0 = CA0, CA_a = CA_a, CA_b = CA_b, CA_dy = CA_dy, CA_dp = CA_dp, CA_dr = CA_dr, CA_ds = CA_ds, CN_a = CN_a, CN_dp = CN_dp, CY_b = CY_b, CY_dy = CY_dy, CLL_dr = CLL_dr, CLM_a = CLM_a, CLM_dp = CLM_dp, CLN_b = CLN_b, CLN_dy = CLN_dy));
