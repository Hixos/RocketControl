...
model LynxM200RNoFins
  ...
  Modelica.Mechanics.MultiBody.Parts.Body fuselage(I_11 = 0.06, I_21 = 0, I_22 = 6.8, I_31 = 0, I_32 = 0, I_33 = 6.8, animation = false, enforceStates = false, m = 21.47, r_CM = {0, 0, 0}, sequence_angleStates = {3, 2, 1}, w_a(start = {0, 0, 0})) annotation(
  ...
  RocketControl.Components.Parachutes.SimpleParachute drogue(CLL_p = -5, Cd = 0.8, d = 0.15, initial_surface = 0.01, opening_delay = 0.5, opening_transient_duration = 0.2, surface = 0.6, useEnablePort = true) annotation(
  ...
  RocketControl.Components.Propulsion.M2000R m2000r(start_delay = 0.5)  annotation(
...
//  end for;
  ...
  connect(nozzle_trans.frame_b, m2000r.frame_b) annotation(
    Line(points = {{-40, -58}, {-40, -74}}, color = {95, 95, 95}));
protected
  annotation(
