...
equation
 ...
 connect(lynxWithCanardsRocket.frame_lug_bow, launchRail.frame_b_lug_bow) annotation(
    Line(points = {{-10, 16}, {-40, 16}}));
 connect(launchRail.frame_b_lug_aft, lynxWithCanardsRocket.frame_lug_aft) annotation(
    Line(points = {{-40, 4}, {-10, 4}}));
protected
  annotation(
      Icon(coordinateSystem(grid = {2, 0})),
      experiment(StartTime = 0, StopTime = 60, Tolerance = 1e-6, Interval = 0.01));
  end LynxLQandActuatorLinear;
